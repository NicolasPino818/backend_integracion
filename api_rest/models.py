...
class Productos(models.Model):
    ...
    trastes = models.CharField(max_length=150, null=True, blank=True)
    mat_cuerpo = models.CharField(max_length=150, null=True, blank=True)
    mat_neck = models.CharField(max_length=150, null=True, blank=True)
    mat_fingerb = models.CharField(max_length=150, null=True, blank=True)

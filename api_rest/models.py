...
class Usuarios(models.Model):
    ...
    persona = models.ForeignKey(Personas, on_delete=models.CASCADE,unique=True)
...
class Compras(models.Model):
    ...
    usuario = models.ForeignKey(Usuarios, on_delete=models.CASCADE,null=True,unique=False)
...
class Rel_Prod_Comp(models.Model):
    producto = models.ForeignKey(Productos, on_delete=models.CASCADE,unique=False)
